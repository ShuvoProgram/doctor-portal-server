...
const uri = `mongodb+srv://${process.env.USER_DB}:${process.env.PASSWORD_DB}@cluster0.iqotg9c.mongodb.net/?retryWrites=true&w=majority`;
...
const sendBookingMail = (booking) => {
    ...
    transporter.sendMail({
        from: 'shuvoprogrammer@gmail.com', // sender address
        to: email || 'shuvoprogrammer@gmail.com', // list of receivers
...
async function run () {
    try{
        const AppointmentOptionCollection = client.db('Doctor-portal').collection('AppointmentOption');
